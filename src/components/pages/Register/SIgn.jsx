...
const Sign = () => {
  ...
  return (
    <div className={style.mainSign}>
      ...
      <MDBInput className='mb-4' type='email' id='form3Example3' placeholder='Email address' />
      <MDBInput className='mb-4' type='password' id='form3Example4'  placeholder='Password' />
<MDBRow style={{
    position:"relative",
    left:"5vh"
}}>
    <MDBCol>You have a account ?</MDBCol>
    <MDBCol> <NavLink to={"/login"}>Login <UserCheck2Icon/></NavLink></MDBCol>
      ...
      }} onClick={handleCickHome}>Retour</MDBBtn>
